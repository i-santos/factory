...
func DefaultConfig(root string) Config {
	...
	cfg.FactorySkill.RequiredSkillVersion = "0.1.0"
	cfg.FactorySkill.RuntimeContract = 1
	cfg.FactorySkill.WorkspaceSchema = 1
...
func InitWorkspace(projectRoot, workspaceRoot string) error {
	...
	return writeJSONIfMissing(filepath.Join(projectRoot, cfg.Events.BindingsPath), bindings)
}
